...
MobileTable.prototype.construct = function () {
    ...
    var obj = this,
        $table = document.getElementById(obj.selector);

    // Find the original table's parent and append a new table to it.  This is
    // what we will turn into our mobile table.
    var mobTable = document.createElement('TABLE');

    mobTable.setAttribute('id', 'tableMobile');
    mobTable.setAttribute('class', 'table mod-mobile');
